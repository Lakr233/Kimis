...
class UsersListTableView: TableView, UITableViewDelegate, UITableViewDataSource, UIScrollViewDelegate {
    ...
    override init() {
        ...
        register(UserCell.self, forCellReuseIdentifier: UserCell.id)
    ...
    func tableView(_: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = dequeueReusableCell(withIdentifier: UserCell.id, for: indexPath) as! UserCell
    ...
    func renderVisibleCellAndUpdate() {
        ...
        beginUpdates()
        for indexPath in visibleIndexPaths {
            guard let cell = cellForRow(at: indexPath) as? UserCell else {
                continue
            }
